        ...
        <div class="row">
            <div class="col-12 col-8 text-center bg-form shadow-lg">
                ...
                <form class="my-5" method="POST" action="{{ 'register' }}">
                    @csrf
                    <div class="mb-3">
                        <label for="email" class="form-label fs-5 fw-bold">Indirizzo mail</label>
                    ...
                    <div class="mb-3">
                        <label for="password_confirmation" class="form-label fs-5 fw-bold">Conferma Password</label>
